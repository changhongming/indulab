                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ Route('quizs.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="test_name" type="text" class="form-control{{ $errors->has('test_name') ? ' is-invalid' : '' }}" name="test_name" value="{{ old('test_name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="test_time" type="number" class="form-control{{ $errors->has('test_time') ? ' is-invalid' : '' }}" name="test_time" value="{{ old('test_time') }}" required>
